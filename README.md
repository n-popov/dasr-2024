...
2а. Реализуйте иерархию геометрических фигур, включающую базовый класс фигуры, круг, квадрат, прямоугольник, эллипс и ромб, но, возможно, не ограничивающуюся ими. Сделайте базовый класс фигуры абстрактным. У фигуры должны быть методы вычисления площади и периметра. Продемонстрируйте работу с фигурами в функции main, создав массив указателей на фигуры и выведя в цикле площадь и периметр соответствующей фигуры.
2б (альтернатива вместо 2а). Реализуйте свою иерархию наследования по любой интересующей вас тематике. Постарайтесь продемонстрировать умение работать с абстрактными классами и виртуальными функции.
3 (опционально). Реализуйте стек или очередь, унаследовавшись от вектора (стандартного либо самописного) по типу наследования is implemented with (private).
